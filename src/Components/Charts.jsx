...
export default function Charts() {
        ...
        const top5 = Object.entries(WrappedData.movies_by_score)
            .flatMap(([rating, movies]) =>
                ...
                return {
                    ...
                    id,
                    title: movie.title,
                    backdrop_path: movie.poster_path || notFound,
                };
                })
            )
    ...
    allRef.updateCharts = processData
                ...
                <div className='charts-body-container'>
                    <div className='charts-body'>
                        ...
                        <div className='charts-first movies charts-child'>
                            ...
                            <img src={`https://image.tmdb.org/t/p/w500${WrappedData.first_movie.data.backdrop_path}`} alt="space" />
                        </div>
                        <div className='charts-last movies charts-child'>
                            <div className='small-text'>
                                <p>Last movie</p>
                            </div>
                            <img src={`https://image.tmdb.org/t/p/w500${WrappedData.last_movie.data.backdrop_path}`} alt="space" />
                        </div>
